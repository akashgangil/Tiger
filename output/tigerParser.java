// $ANTLR 3.5.1 /Users/twb/repos/Tiger/Tiger.g 2014-10-04 20:21:00
...
public class TigerParser extends Parser {
		...
		try {
			...
			switch (alt6) {
				case 1 :
					...
					// AST REWRITE
					// elements: param, param_list_tail, param
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt20) {
				...
				case 2 :
					...
					// AST REWRITE
					// elements: statement_assignment, ASSIGN, statement_assignment, ASSIGN, optional_subscript
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final TigerParser.if_stmt_return if_stmt() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: stat_seq, else_stmt, expr, IF
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
